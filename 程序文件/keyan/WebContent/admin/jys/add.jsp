...
<div class="title_right"><strong>增加财务人员</strong></div>  
...
<table class="table table-bordered">
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">工号：</td>
     ...
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">备注：</td>
