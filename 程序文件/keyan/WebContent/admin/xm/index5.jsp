...
<div class="title_right"><strong>待审批申请单目录</strong></div>  
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
      <tr align="center">
         ...
         <td width="80" nowrap="nowrap"><strong>操作</td>
       </tr>
<%   
	cb.setEVERYPAGENUM(12);
	int cou = cb.getMessageCount("select count(*) from xm where sh='通过' and zj='暂无' or zj='null'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from xm where sh='通过' and zj='暂无' or zj='null' order by id desc",17);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap">
         <a href="<%=basePath%>admin/xm/spj.jsp?method=jxm&id=<%=pagelist2.get(0).toString()%>">审批</a>
