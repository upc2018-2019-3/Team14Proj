	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
            ...
            if(method.equals("addwj")){// 上传文件 
            	...
            	int a = Integer.parseInt(mc); 
            	int b = Integer.parseInt(fzr); 
            	int c = Integer.parseInt(xk); 
            	int d=a+b+c;
            	String jf = String.valueOf(d); 
            	...
            	if(count==0){
            		int flag=cb.comUp("update xm set bh='"+bh+"',mc='"+mc+"',fzr='"+fzr+"',lb='"+lb+"',xk='"+xk+"',jf='"+jf+"',ksj='"+ksj+"',esj='"+esj+"'," +
            				"yh='"+username+"',dw='"+dw+"',sj='"+date2+"' ,sh='暂无',yj='暂无',zj='暂无',zhj='暂无' where id='"+id+"'");
    				if(flag == Constant.SUCCESS){ 
    					
    					request.setAttribute("message", "操作成功！");
    					request.getRequestDispatcher("admin/xm/indexx.jsp").forward(request, response); 
            		...
            		int flag=cb.comUp("update xm set bh='"+bh+"',mc='"+mc+"',fzr='"+fzr+"',lb='"+lb+"',xk='"+xk+"',jf='"+jf+"',ksj='"+ksj+"',esj='"+esj+"'," +
            				"url='"+path+"/"+file.getFileName()+"',yh='"+username+"',dw='"+dw+"',sj='"+date2+"',sh='暂无',yj='暂无',zj='暂无',zhj='暂无' where id='"+id+"'"); 
            		if(flag == Constant.SUCCESS){ 
    					request.setAttribute("message", "操作成功！");
    					request.getRequestDispatcher("admin/xm/index.jsp").forward(request, response); 
    				}
