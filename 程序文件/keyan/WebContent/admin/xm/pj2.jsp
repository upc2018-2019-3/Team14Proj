...
<div class="title_right"><strong>已支付申请单目录</strong></div>  
...
<%   
	...
	int cou = cb.getMessageCount("select count(*) from xm where sh='通过' and zj='通过' and pf!='null' and pf!='暂无'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from xm where sh='通过' and zj='通过' and pf!='null' and pf!='暂无' order by id desc",18);
