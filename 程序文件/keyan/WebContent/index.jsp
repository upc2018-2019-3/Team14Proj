   ...
   <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" class="rtable">
	  <tbody>
	     <tr class="tr1">
			...
			<td class="rltitle daslist">&nbsp;&nbsp;&nbsp;&nbsp;<p style="font-family:Microsoft Yahei;color:#191970;font-size:20px;">用户登录</p></td> 
         </tr>
	     <tr class="tr1">
         ...
         <tr class="tr1">
            ...
            <INPUT type="radio" name="sf" value="普通职工" checked="checked"> 普通职工
            <input type="radio" name="sf" value="部门经理" > 部门经理
            <input type="radio" name="sf" value="财务人员" > 财务人员
