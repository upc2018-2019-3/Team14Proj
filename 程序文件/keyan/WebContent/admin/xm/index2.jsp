...
<%   
	...
	int cou = cb.getMessageCount("select count(*) from xm where dw='"+dw+"' and sh='null' or sh='暂无'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from xm where dw='"+dw+"' and sh='null' or sh='暂无' order by id desc",17);
