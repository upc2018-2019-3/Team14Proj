...
<div class="title_right"><strong>财务人员信息</strong></div>  
...
<%String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	int cou = cb.getMessageCount("select count(*) from admin where username like '%"+word+"%' or realname like '%"+word+"%' and sf ='财务人员'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where username like '%"+word+"%' or realname like '%"+word+"%'  and sf ='财务人员' order by id desc",10);
