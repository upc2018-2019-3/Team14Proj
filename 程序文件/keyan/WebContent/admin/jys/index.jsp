...
<div class="title_right"><strong>财务人员名单</strong></div>  
...
<%
	...
	int cou = cb.getMessageCount("select count(*) from admin where sf ='财务人员'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where sf ='财务人员' order by id desc",10);
