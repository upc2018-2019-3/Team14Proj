...
<div class="title_right"><strong>部门经理信息</strong></div>  
...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap"><strong>工号</strong></td>
...
<%String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	int cou = cb.getMessageCount("select count(*) from admin where username like '%"+word+"%' or realname like '%"+word+"%' and sf ='部门经理'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where username like '%"+word+"%' or realname like '%"+word+"%'  and sf ='部门经理' order by id desc",10);
