...
<%   
	...
	int cou = cb.getMessageCount("select count(*) from xm where dw='"+dw+"' and sh='通过' or sh='未通过'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from xm where dw='"+dw+"' and sh='未通过' or sh='通过' order by id desc",17);
