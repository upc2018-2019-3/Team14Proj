...
<div class="title_right"><strong>申请单管理</strong></div>  
<div style="width:100%;margin:auto;">
<form action="" method="post" name="form3">	
<table class="table table-bordered table-striped table-hover">
     <tbody>
        <tr align="center">
         <td nowrap="nowrap"><strong>序号</td>
         <td nowrap="nowrap"><strong>申请单编号</td> 
         <td nowrap="nowrap"><strong>申请人工号</td>
         <td nowrap="nowrap"><strong>申请人姓名</td> 
         <td nowrap="nowrap"><strong>所在部门</td>
         <td nowrap="nowrap"><strong>出差事由</td> 
         <td nowrap="nowrap"><strong>住宿费</td>
         <td nowrap="nowrap"><strong>交通费</td>
         <td nowrap="nowrap"><strong>伙食费</td>
         <td nowrap="nowrap"><strong>其他费用</td>
         <td nowrap="nowrap"><strong>报销总额</td>
         <td nowrap="nowrap"><strong>出差开始时间</td>
         <td nowrap="nowrap"><strong>出差结束时间</td>
         <td nowrap="nowrap"><strong>附件</td>
         <td nowrap="nowrap"><strong>一审状态</td>
         <td nowrap="nowrap"><strong>审核意见</td>
         <td nowrap="nowrap"><strong>二审状态</td>
         <td nowrap="nowrap"><strong>审核意见</td>
