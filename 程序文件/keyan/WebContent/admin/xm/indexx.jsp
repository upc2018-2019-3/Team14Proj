...
<div class="title_right"><strong>未通过审批的申请单目录</strong></div>  
...
<%   
	...
	int cou = cb.getMessageCount("select count(*) from xm where yh='"+username+"' and sh='未通过' or zj='未通过'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from xm where yh='"+username+"' and sh='未通过' or zj='未通过' order by id desc",18);
