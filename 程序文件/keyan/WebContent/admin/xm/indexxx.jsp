...
<%   
	...
	int cou = cb.getMessageCount("select count(*) from xm where yh='"+username+"' and pf!='null' and pf!='暂无'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from xm where yh='"+username+"' and pf!='null' and pf!='暂无' order by id desc",18);
