...
<div class="title_right"><strong>待支付申请单目录</strong></div>  
...
<table class="table table-bordered table-striped table-hover">
      <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap"><strong>申请单编号</strong></td>
         <td nowrap="nowrap"><strong>申请人</strong></td> 
         <td nowrap="nowrap"><strong>所在部门</strong></td>
         <td nowrap="nowrap"><strong>住宿费</strong></td> 
         <td nowrap="nowrap"><strong>交通费</strong></td> 
         <td nowrap="nowrap"><strong>伙食费</strong></td>
         <td nowrap="nowrap"><strong>报销总额</strong></td>
         ...
         <td nowrap="nowrap"><strong>一审</strong></td>
         <td nowrap="nowrap"><strong>一审意见</strong></td>
         <td nowrap="nowrap"><strong>二审</strong></td>
         <td nowrap="nowrap"><strong>二审意见</strong></td>
         <td nowrap="nowrap"><strong>支付</strong></td>
         <td width="80" nowrap="nowrap"><strong>操作</strong></td>
       </tr>
<%   
	cb.setEVERYPAGENUM(12);
	int cou = cb.getMessageCount("select count(*) from xm where sh='通过' and zj='通过' and pf='暂无' or pf='null' ");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from xm where sh='通过' and zj='通过' and pf='暂无' or pf='null' order by id desc",18);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap"> 
         <a href="<%=basePath%>admin/xm/pjadd.jsp?method=pjxm&id=<%=pagelist2.get(0).toString()%>">支付</a>
         </td>
       </tr>
<% }} %>
       <tr align="center">
